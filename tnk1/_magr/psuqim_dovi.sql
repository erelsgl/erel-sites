...
LOAD DATA LOCAL INFILE '$BACKUP_FILEROOT/psuqim_dovi.txt'  INTO TABLE psuqim_dovi (book,book_name,book_code_mamre,chapter,chapter_number,chapter_id,verse_letter,verse_number,prefix,verse_text);
