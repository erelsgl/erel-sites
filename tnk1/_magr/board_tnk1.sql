...
SET character_set_connection=utf8mb3;
		...
		UPDATE board_tnk1
		SET newest_child_created_at='2026-01-04 10:41:57'
		WHERE ktovt_bn='tnk1/messages/prqim_t0232_5.html'
		;
...
SET character_set_connection=hebrew;
		...
		VALUES (
				'tnk1/forums.html',
				'tnk1/messages/forums_1809.html',
				NULL,
				'2026-01-06 10:13:01',
				'2026-01-06 10:13:01',
				'דוד המלך וציוויו לשלמה/שיר מאת: אהובה קליין (c)',
				'אהובה קליין',
				''
			)
		;
...
SET character_set_connection=hebrew;
		...
		VALUES (
				'tnk1/forums.html',
				'tnk1/messages/forums_1810.html',
				NULL,
				'2026-01-08 22:31:32',
				'2026-01-08 22:31:32',
				'פרשת שמות- מאין כי דורשי ה\' לא יחסרו כל טוב?/ אהובה קליין',
				'אהובה קליין',
				''
			)
		;
...
SET character_set_connection=hebrew;
			...
			UPDATE board_tnk1
			SET newest_child_created_at='2026-01-08 22:31:32'
			WHERE ktovt_bn='tnk1/forums.html';
...
SET character_set_connection=hebrew;
		...
		VALUES (
				'tnk1/forums.html',
				'tnk1/messages/forums_1811.html',
				NULL,
				'2026-01-08 22:35:01',
				'2026-01-08 22:35:01',
				'דורשי ה\' נושעים/ שיר מאת: אהובה קליין (c)',
				'אהובה קליין',
				''
			)
		;
...
SET character_set_connection=hebrew;
		...
		VALUES (
				'tnk1/forums.html',
				'tnk1/messages/forums_1814.html',
				NULL,
				'2026-01-22 22:26:54',
				'2026-01-22 22:26:54',
...
SET character_set_connection=hebrew;
			...
			UPDATE board_tnk1
			SET newest_child_created_at='2026-01-22 22:26:54'
			WHERE ktovt_bn='tnk1/forums.html';
...
SET character_set_connection=hebrew;
		...
		VALUES (
				'tnk1/forums.html',
				'tnk1/messages/forums_1815.html',
				NULL,
				'2026-01-23 12:56:55',
				'2026-01-23 12:56:55',
				'אלוקים מבטיח ומקיים/ שיר מאת: אהובה קליין (c)',
				'אהובה קליין',
				''
			)
		;
...
SET character_set_connection=hebrew;
			...
			UPDATE board_tnk1
			SET newest_child_created_at='2026-01-23 12:56:55'
			WHERE ktovt_bn='tnk1/forums.html';
