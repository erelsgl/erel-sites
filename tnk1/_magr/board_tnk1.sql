...
SET character_set_connection=hebrew;
		...
		VALUES (
				...
				'2014-09-08 17:28:52',
				'2014-09-08 17:28:52',
				'äöã÷ äàåé÷ìéãé äåà îä ùäéä äåà ùéäéä',
				'øîé ğéø  ',
				''
			)
		;
...
SET character_set_connection=hebrew;
		...
		VALUES (
				...
				'2014-09-09 18:57:54',
				'2014-09-09 18:57:54',
				'ùîåú äîô÷ãéí áéùøàì àéğí éùøàìééí',
				'çâé äåôø',
				''
			)
		;
...
SET character_set_connection=hebrew;
		...
		VALUES (
				...
				'2014-09-10 09:47:33',
				'2014-09-10 09:47:33',
				'ëîä äøäåøéí áğåùà æåâéåú åäøöàåú',
				'çâé äåôø',
				''
			)
		;
...
SET character_set_client=utf8;
SET character_set_connection=utf8;
INSERT INTO `board_tnk1` (`ktovt_av`, `sug`, `created_at`, `newest_child_created_at`, `ktovt_bn`, `kotrt`, `m`, `l`, `sdr_bn`) VALUES ('tnk1/forums.html', NULL, '2014-06-30 11:11:02', '2014-06-30 11:11:02', 'tnk1/messages/forums_614.html', '×”× ×—×©/ ×©×™×¨ ×××ª: ××”×•×‘×” ×§×œ×™×™×Ÿ(c)', '××”×•×‘×” ×§×œ×™×™×Ÿ.', NULL, NULL);

SET character_set_client=utf8;
SET character_set_connection=utf8;
INSERT INTO `board_tnk1` (`ktovt_av`, `sug`, `created_at`, `newest_child_created_at`, `ktovt_bn`, `kotrt`, `m`, `l`, `sdr_bn`) VALUES ('tnk1/forums.html', NULL, '2014-07-02 21:27:44', '2014-07-02 21:27:44', 'tnk1/messages/forums_616.html', '×‘×œ×§ ××œ×š ××•××‘/ ×©×™×¨ ×××ª: ××”×•×‘×” ×§×œ×™×™×Ÿ(c)', '××”×•×‘×” ×§×œ×™×™×Ÿ.', NULL, NULL);

SET character_set_client=utf8;
SET character_set_connection=utf8;
INSERT INTO `board_tnk1` (`ktovt_av`, `sug`, `created_at`, `newest_child_created_at`, `ktovt_bn`, `kotrt`, `m`, `l`, `sdr_bn`) VALUES ('tnk1/forums.html', NULL, '2014-07-07 22:15:59', '2014-07-07 22:15:59', 'tnk1/messages/forums_618.html', '××œ×™×”×• ×”× ×‘×™× ×‘××“×‘×¨/×©×™×¨ ×××ª: ××”×•×‘×” ×§×œ×™×™×Ÿ(c)', '××”×•×‘×” ×§×œ×™×™×Ÿ.', NULL, NULL);
...
UPDATE board_tnk1
			SET sug='××××¨', sdr_bn=NULL
			WHERE ktovt_bn='tnk1/messages/forums_615.html';
...
UPDATE board_tnk1
			SET sug='××××¨', sdr_bn=NULL
			WHERE ktovt_bn='tnk1/messages/forums_617.html';

SET character_set_client=utf8;
SET character_set_connection=utf8;
UPDATE board_tnk1
			SET sug='×“×™×•×Ÿ1', sdr_bn=NULL
			WHERE ktovt_bn='tnk1/nvia/yjayhu/yj-33-06.html';

SET character_set_client=utf8;
SET character_set_connection=utf8;
UPDATE board_tnk1
			SET sug='×›×œ×œ_××–×•×¨', sdr_bn=NULL
			WHERE ktovt_bn='tnk1/messages/ljon_jorj_psx_1.html';

SET character_set_client=utf8;
SET character_set_connection=utf8;
UPDATE board_tnk1
			SET sug='××××¨', sdr_bn=NULL
			WHERE ktovt_bn='tnk1/messages/sofrim_hagay_index_103.html';

SET character_set_client=utf8;
SET character_set_connection=utf8;
UPDATE board_tnk1
			SET sug='×ª×›×œ×™×ª', sdr_bn=NULL
			WHERE ktovt_bn='tnk1/messages/dmut_dmut_528_0.html';

SET character_set_client=utf8;
SET character_set_connection=utf8;
UPDATE board_tnk1
			SET sug='×¤×¨×˜×™×1', sdr_bn=NULL
			WHERE ktovt_bn='tnk1/messages/ljon_jorj_rwx_0.html';
...
UPDATE board_tnk1
			SET sug='××××¨', sdr_bn=NULL
			WHERE ktovt_bn='tnk1/messages/hawyqlydy_hwa_mh_jhyh_hwa_jyhyh.pdf';

SET character_set_client=utf8;
SET character_set_connection=utf8;
UPDATE board_tnk1
			SET sug='×›×œ×œ', sdr_bn=NULL
			WHERE ktovt_bn='tnk1/messages/prqim_t2701_4.html';
...
UPDATE board_tnk1
			SET sug='×‘×¡×™×¡', sdr_bn=NULL
			WHERE ktovt_bn='tnk1/messages/prqim_t0136_1.html';

SET character_set_client=utf8;
SET character_set_connection=utf8;
UPDATE board_tnk1
			SET sug='×›×œ×œ', sdr_bn=NULL
			WHERE ktovt_bn='tnk1/messages/prqim_t3107_8.html';
...
SET character_set_connection=utf8;
		...
		UPDATE board_tnk1
		SET newest_child_created_at='2014-09-11 11:04:17'
		WHERE ktovt_bn='tnk1/ktuv/mjly/mj-31-10.html'
		;
...
SET character_set_connection=utf8;
		...
		UPDATE board_tnk1
		SET newest_child_created_at='2014-09-11 11:05:37'
		WHERE ktovt_bn='tnk1/ktuv/mjly/mj-31-10.html'
		;
...
SET character_set_connection=utf8;
		...
		UPDATE board_tnk1
		SET newest_child_created_at='2014-09-11 11:06:47'
		WHERE ktovt_bn='tnk1/ktuv/mjly/mj-31-10.html'
		;
...
SET character_set_connection=utf8;
		...
		UPDATE board_tnk1
		SET newest_child_created_at='2014-09-11 15:26:49'
		WHERE ktovt_bn='tnk1/ktuv/mjly/mj-31-10.html'
		;
...
SET character_set_connection=utf8;
		...
		UPDATE board_tnk1
		SET newest_child_created_at='2014-09-11 15:35:21'
		WHERE ktovt_bn='tnk1/ktuv/mjly/mj-31-10.html'
		;
...
SET character_set_connection=utf8;
		...
		UPDATE board_tnk1
		SET newest_child_created_at='2014-09-11 16:42:49'
		WHERE ktovt_bn='tnk1/ktuv/mjly/mj-31-10.html'
		;
...
SET character_set_connection=utf8;
		...
		UPDATE board_tnk1
		SET newest_child_created_at='2014-09-11 21:08:38'
		WHERE ktovt_bn='tnk1/tora/tk12.html'
		;
...
SET character_set_connection=hebrew;
		...
		INSERT INTO board_tnk1 (ktovt_av, ktovt_bn, sdr_bn, created_at, newest_child_created_at, kotrt, m, l)
		VALUES (
				'tnk1/dmut/dmut/398.html',
				'tnk1/nvir/joftim/jf-12-01.html',
				NULL,
				'2014-09-12 06:23:24',
				'2014-09-12 06:23:24',
				'éôúç ì÷ç àú äçå÷ ìéãééí ëãé ìäâï òì ùáèå',
				'àøàì',
				''
			)
		;
...
SET character_set_connection=hebrew;
		...
		VALUES (
				...
				'2014-09-12 06:41:47',
				'2014-09-12 06:41:47',
				'àéñåø ëøéúú áøéú ìà çì òì ëì òîé ëğòï àìà ø÷ òì ùáòä îúåëí',
				'àøàì',
				''
			)
		;
...
SET character_set_connection=hebrew;
			...
			DELETE FROM board_tnk1
			WHERE ktovt_bn='tnk1/nvir/joftim/ma-05-26.html';
...
SET character_set_connection=hebrew;
		...
		INSERT INTO board_tnk1 (ktovt_av, ktovt_bn, sdr_bn, created_at, newest_child_created_at, kotrt, m, l)
		VALUES (
				'tnk1/klli/mdrjim/rmbm0.html',
				'tnk1/klli/mdrjim/rmbm7.html',
				NULL,
				'2014-09-12 07:02:03',
				'2014-09-12 07:02:03',
				'ùáò îöååú áğé ğåç äï úğàé ìùìåí',
				'àøàì',
				''
			)
		;
...
SET character_set_connection=hebrew;
		...
		VALUES (
				...
				'2014-09-12 07:10:01',
				'2014-09-12 07:10:01',
				'áùğä äùáéòéú àğçğå àåøçéí-ìùáú ùì äàøõ',
				'àøàì',
				''
			)
		;
