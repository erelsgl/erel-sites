...
SET character_set_connection=hebrew;
		...
		VALUES (
				...
				'2017-10-17 18:33:10',
				'2017-10-17 18:33:10',
				'ôøùú ğç- áîä çèàå åğòğùå ãåø äôìâä?/àäåáä ÷ìééï',
				'àäåáä ÷ìééï',
				''
			)
		;
...
SET character_set_connection=hebrew;
		...
		VALUES (
				...
				'2017-10-17 20:28:57',
				'2017-10-17 20:28:57',
				'àğùé ãåø äôìâä/ùéø îàú: àäåáä ÷ìééï(c)',
				'àäåáä ÷ìééï',
				''
			)
		;
...
SET character_set_connection=hebrew;
		...
		VALUES (
				...
				'2017-10-24 19:38:23',
				'2017-10-24 19:38:23',
				'ôøùú ìê-ìê:áãøê ùàãí øåöä ìéìê áä îåìéëéï àåúå/àäåáä ÷ìééï',
				'àäåáä ÷ìééï',
				''
			)
		;
...
SET character_set_connection=hebrew;
		...
		VALUES (
				...
				'2017-10-24 21:41:33',
				'2017-10-24 21:41:33',
				'\"àğé ÷äìú – î÷äìú ÷åìåú áãîåú àçú\" îàú éåàì áï-ğåï åéò÷á îãï',
				'çâé äåôø',
				''
			)
		;
...
SET character_set_connection=hebrew;
		...
		VALUES (
				...
				'2017-10-25 18:51:23',
				'2017-10-25 18:51:23',
				' àáøäí åäìéëúå/ ùéø îàú: àäåáä ÷ìééï',
				'àäåáä ÷ìééï',
				''
			)
		;
...
SET character_set_connection=hebrew;
		...
		VALUES (
				...
				'2017-10-30 18:24:40',
				'2017-10-30 18:24:40',
				'ôøùú åéøà-îãåò éùá ìåè áùòø ñãåí?/àäåáä ÷ìééï',
				'àäåáä ÷ìééï',
				''
			)
		;
...
SET character_set_connection=hebrew;
		...
		VALUES (
				...
				'2017-10-31 20:03:12',
				'2017-10-31 20:03:12',
				'ìåè áùòø ñãåí/ ùéø îàú: àäåáä ÷ìééï',
				'àäåáä ÷ìééï',
				''
			)
		;
...
SET character_set_connection=hebrew;
		...
		VALUES (
				...
				'2017-11-06 17:14:04',
				'2017-11-06 17:14:04',
				'îé ùàåîø òì ëåìí ùäí ñëìéí - äåà áòöîå ñëì',
				'àøàì',
				''
			)
		;
...
SET character_set_connection=hebrew;
		...
		VALUES (
				...
				'2017-11-06 19:37:21',
				'2017-11-06 19:37:21',
				' ôøùú çéé ùøä-îä âğåæ áùéãåê äøàùåï áúåøä?/àäåáä ÷ìééï',
				'àäåáä ÷ìééï',
				''
			)
		;
...
SET character_set_connection=hebrew;
		...
		VALUES (
				...
				'2017-11-07 20:47:30',
				'2017-11-07 20:47:30',
				'ùàìú ôé äğòøä/ ùéø îàú: àäåáä ÷ìééï (c)',
				'àäåáä ÷ìééï',
				''
			)
		;
...
SET character_set_connection=hebrew;
		...
		VALUES (
				...
				'2017-11-08 03:09:33',
				'2017-11-08 03:09:33',
				'îàåéáéé úçëîğé îöååúéê, ëé ìòåìí äéà ìé',
				'àøàì',
				''
			)
		;
...
SET character_set_connection=hebrew;
		...
		VALUES (
				...
				'2017-11-13 19:03:27',
				'2017-11-13 19:03:27',
				'ôøùú úåìãåú- òùéå ùåğà ìéò÷á- äàåîğí?/àäåáä ÷ìééï',
				'àäåáä ÷ìééï',
				''
			)
		;
...
SET character_set_connection=hebrew;
		...
		VALUES (
				...
				'2017-11-16 21:15:35',
				'2017-11-16 21:15:35',
				'òùéå àéù öéã/ ùéø îàú: àäåáä ÷ìééï (c)',
				'àäåáä ÷ìééï',
				''
			)
		;
...
SET character_set_connection=hebrew;
		...
		VALUES (
				...
				'2017-11-20 21:44:38',
				'2017-11-20 21:44:38',
				' øçì åäåìãú éåñó/ùéø îàú: àäåáä ÷ìééï(c)',
				'àäåáä ÷ìééï',
				''
			)
		;
...
SET character_set_connection=hebrew;
		...
		VALUES (
				...
				'2017-11-21 05:53:27',
				'2017-11-21 05:53:27',
				'ôøùú åéöà: îä æëø àìå÷éí ìøçì?/ àäåáä ÷ìééï',
				'àäåáä ÷ìééï',
				''
			)
		;
...
SET character_set_connection=hebrew;
		...
		VALUES (
				...
				'2017-11-22 06:02:18',
				'2017-11-22 06:02:18',
				'èåá éìã îñëï åçëí îîìê æ÷ï åëñéì',
				'àøàì',
				''
			)
		;
...
SET character_set_connection=hebrew;
		...
		VALUES (
				...
				'2017-11-25 20:31:37',
				'2017-11-25 20:31:37',
				'òì äøøé öéåï îòâì áøëä = çééí òã äòåìí',
				'øîé ğéø  ',
				''
			)
		;
...
SET character_set_connection=hebrew;
		...
		VALUES (
				...
				'2017-11-28 09:44:34',
				'2017-11-28 09:44:34',
				'òì \"îéï àñåø, îéï îåúø\" îàú ğéìé áåëîï ñìåğéîñ÷é',
				'çâé äåôø',
				''
			)
		;
...
SET character_set_connection=hebrew;
		...
		VALUES (
				...
				'2017-11-28 10:17:54',
				'2017-11-28 10:17:54',
				'ôøùú åéùìç- îãåò òùéå äúçúï áâéì àøáòéí?/àäåáä ÷ìééï',
				'àäåáä ÷ìééï',
				''
			)
		;
...
SET character_set_connection=hebrew;
		...
		VALUES (
				...
				'2017-11-28 20:56:46',
				'2017-11-28 20:56:46',
				'òùéå åğùåúéå/ùéø îàú: àäåáä ÷ìééï (c)',
				'àäåáä ÷ìééï',
				''
			)
		;
...
SET character_set_connection=hebrew;
		...
		VALUES (
				...
				'2017-12-05 19:45:20',
				'2017-12-05 19:45:20',
				'ôøùú åéùá- îãåò æëä éåñó ìäöìçä áîöøéí?/àäåáä ÷ìééï',
				'àäåáä ÷ìééï',
				''
			)
		;
...
SET character_set_connection=hebrew;
		...
		VALUES (
				...
				'2017-12-06 18:23:39',
				'2017-12-06 18:23:39',
				'éåñó àéù îöìéç/ùéø îàú: àäåáä ÷ìééï (c)',
				'àäåáä ÷ìééï',
				''
			)
		;
...
SET character_set_connection=hebrew;
		...
		VALUES (
				...
				'2017-12-10 13:37:51',
				'2017-12-10 13:37:51',
				'ùìåù ğ÷åãåú î\"ñôøåú äî÷øà – îáåàåú åîç÷øéí\"',
				'çâé äåôø',
				''
			)
		;
...
SET character_set_connection=hebrew;
		...
		VALUES (
				...
				'2017-12-11 20:15:46',
				'2017-12-11 20:15:46',
				'ôøùú î÷õ- ñåã äéöéàä îàôìä ìàåøä!/ àäåáä ÷ìééï',
				'àäåáä ÷ìééï',
				''
			)
		;
...
SET character_set_connection=hebrew;
		...
		VALUES (
				...
				'2017-12-12 09:51:51',
				'2017-12-12 09:51:51',
				'éåñó îúòìä/ ùéø îàú: àäåáä ÷ìééï(c)',
				'àäåáä ÷ìééï',
				''
			)
		;
...
SET character_set_connection=hebrew;
		...
		VALUES (
				...
				'2017-12-16 18:28:09',
				'2017-12-16 18:28:09',
				'àúø ñôøéà - ùôò ôéøåùéí åúøâåîéí òì äúğê',
				'àáéúø ëäï',
				''
			)
		;
...
SET character_set_connection=hebrew;
		...
		VALUES (
				...
				'2017-12-19 06:25:54',
				'2017-12-19 06:25:54',
				'ôøùú åéâù- ìá îìëéí åùøéí áéã ä\'- äàîğí?/àäåáä ÷ìééï',
				'àäåáä ÷ìééï',
				''
			)
		;
...
SET character_set_connection=hebrew;
		...
		VALUES (
				...
				'2017-12-20 03:58:03',
				'2017-12-20 03:58:03',
				'äğáéà éçæ÷àì ğåùà àú òååï éùøàì',
				'àøàì',
				''
			)
		;
...
SET character_set_connection=hebrew;
		...
		VALUES (
				...
				'2017-12-26 17:41:00',
				'2017-12-26 17:41:00',
				'ôøùú åéçé- éåñó áéîéå äàçøåğéí- äéùâéå åá÷ùúå/àäåáä ÷ìééï',
				'àäåáä ÷ìééï',
				''
			)
		;
...
SET character_set_connection=hebrew;
		...
		VALUES (
				...
				'2017-12-26 18:33:44',
				'2017-12-26 18:33:44',
				'éåñó áæ÷ğúå/ ùéø îàú: àäåáä ÷ìééï',
				'àäåáä ÷ìééï',
				''
			)
		;
