...
LOAD DATA LOCAL INFILE '$BACKUP_FILEROOT/sgulot.txt'  INTO TABLE sgulot (book,chapter_letter,chapter_number,verse_number,prefix,main_qod,verse_text,pages,mcudot,tirgum,main_qod_subjects,ecot,hqblot,dquyot,tosfot,full,kotrt);
