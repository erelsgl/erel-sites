...
SET character_set_connection=utf8;
		...
		UPDATE tguvot_data
		SET count=count+1, updated_at='2015-04-23 09:55:05'
		WHERE parent='tnk1/messages/prqim_t2674_0.html'
		;
...
SET character_set_connection=utf8;
			...
			UPDATE tguvot_data
			SET count=count-1, updated_at='2015-04-23 09:55:06'
			WHERE parent='tnk1/messages/prqim_t2674_0.html'
			;
...
SET character_set_connection=utf8;
		...
		UPDATE tguvot_data
		SET count=count+1, updated_at='2015-04-23 09:57:34'
		WHERE parent='tnk1/messages/prqim_t2674_0.html'
		;
...
SET character_set_connection=utf8;
			...
			UPDATE tguvot_data
			SET count=count-1, updated_at='2015-04-23 09:57:36'
			WHERE parent='tnk1/messages/prqim_t2674_0.html'
			;
