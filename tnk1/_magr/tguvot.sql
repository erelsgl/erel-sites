...
SET character_set_connection=utf8mb3;
		...
		INSERT INTO tguvot (parent,body,userid,username,created_at) VALUES (
		'tnk1/tora/jmot/jm-35-10.html',
		'<p>לגבי הפירוש השני:</p><p>נראה לי שזה לא שאנשים חכמים מתחכמים כדי להשתמט, אלא שהם מעריכים את עצמם בחוסר, או מפחדים אל מול גודל המשימה. ציטוט מויקיפדיה:</p><p>&quot;אפקט דאנינג־קרוגר הוא הטיה קוגניטיבית [...] אנשים בעלי ידע נרחב [...] נוטים להעריך את עצמם באופן נמוך מערכם האמיתי. [...] אדם בעל השכלה מרובה בתחום מסוים ומודעות להיקפו הרחב של תחום זה, עלול להעריך בחסר את הידע שלו ביחס לגבולות הרחבים של התחום&quot;</p><p>הפסוק גם מרגיע אנשים כאלה: הוא פותח ביחיד, &quot;חכם לב&quot;, ומסיים ברבים, &quot;ובואו ויעשו&quot;, כדי שאנשים ידעו שזו עבודת צוות והם לא לבד.</p>',
		'114091384146265793446',
		'Niccolo Medici',
		'2026-01-07 12:00:20'
		)
		;
...
SET character_set_connection=utf8mb3;
			...
			UPDATE tguvot 
			SET deleted_at='2026-01-09 13:12:44' 
			WHERE messageid=12371;
