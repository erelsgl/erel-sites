...
SET character_set_connection=utf8;
			...
			UPDATE tguvot 
			SET deleted_at='2015-04-01 21:45:52' 
			WHERE messageid=5199;
...
SET character_set_connection=utf8;
		...
		'<p> 1617 שנה = 33 * 49 [מחזור שנת יובל] </p><p>+ 39 שנה = מגיעים ליום חמשי ראש השנה</p><p>בראשית ז11: </p><p>&quot;בִּשְׁנַת שֵׁשׁ מֵאוֹת שָׁנָה לְחַיֵּי נֹחַ בַּחֹדֶשׁ הַשֵּׁנִי בְּשִׁבְעָה עָשָׂר יוֹם לַחֹדֶשׁ בַּיּוֹם הַזֶּה נִבְקְעוּ כָּל מעינות תְּהוֹם רַבָּה וַאֲרֻבֹּת הַשָּׁמַיִם נִפְתָּחוּ&quot;</p><p>על כן זה יוצא ביום ראשון [אם סופרים עד 17 לחודש השני מראש השנה ביום חמשי]</p><p>כי מיום חמשי ראש השנה ראש החודש הראשון יספרו 30 יום עד יום שבת בראש החודש השני</p><p>ואז נוסיף 16 יום עד השבעה-עשר לחודש השני לאמור 46 יום כדי להגיע ליום 47 הוא יום אחד בשבוע</p><p>ובשנה הבאה שנת 1657 ראש החודש הראשון ביום אחד לשבוע</p><p>ובארץ יבשה גם היא ביום אחד לשבוע</p><p>  </p><p> </p>',
		'https://www.google.com/accounts/o8/id?id=AItOawkimwFyqevXh2gjrVPHX9qj0eFdlDWJLww',
		'Daian Moshe',
		'2015-04-03 11:17:55'
		)
...
SET character_set_connection=utf8;
		...
		INSERT INTO tguvot (parent,body,userid,username,created_at) VALUES (
		'tnk1/messages/prqim_t0108_1.html',
		'<p>1617 שנה = 33 * 49 [מחזור שנת יובל]</p><p>+ 39 שנה = מגיעים ליום חמשי ראש השנה</p><p>בראשית ז11:</p><p>&quot;בִּשְׁנַת שֵׁשׁ מֵאוֹת שָׁנָה לְחַיֵּי נֹחַ בַּחֹדֶשׁ הַשֵּׁנִי בְּשִׁבְעָה עָשָׂר יוֹם לַחֹדֶשׁ בַּיּוֹם הַזֶּה נִבְקְעוּ כָּל מעינות תְּהוֹם רַבָּה וַאֲרֻבֹּת הַשָּׁמַיִם נִפְתָּחוּ&quot;</p><p>על כן זה יוצא ביום ראשון [אם סופרים עד 17 לחודש השני מראש השנה ביום חמשי]</p><p>כי מיום חמשי ראש השנה ראש החודש הראשון יספרו 30 יום עד יום שבת בראש החודש השני</p><p>ואז נוסיף 16 יום עד השבעה-עשר לחודש השני לאמור 46 יום כדי להגיע ליום 47 הוא יום אחד בשבוע</p><p>ובשנה הבאה שנת 1657 ראש החודש הראשון ביום אחד לשבוע</p><p>והארץ יבשה גם היא ביום אחד לשבוע</p>',
		'https://www.google.com/accounts/o8/id?id=AItOawkimwFyqevXh2gjrVPHX9qj0eFdlDWJLww',
		'Daian Moshe',
		'2015-04-03 11:18:39'
		)
...
SET character_set_connection=utf8;
			...
			UPDATE tguvot 
			SET deleted_at='2015-04-03 11:18:44' 
			WHERE messageid=5200;

SET character_set_client=utf8;
SET character_set_connection=utf8;

			UPDATE tguvot 
			SET deleted_at='2015-04-03 11:43:54' 
			WHERE messageid=5201;
...
SET character_set_connection=utf8;
		...
		INSERT INTO tguvot (parent,body,userid,username,created_at) VALUES (
		'tnk1/messages/prqim_t0108_1.html',
		'<p>שנת 1617 = 33 יובלים כפול 49 [מחזור שנת יובל]</p><p>+6 = 1623 יום ששי</p><p>+6 = 1629 יום חמשי</p><p>+6 = 1635 יום רבעי</p><p>+6 = 1641 יום שלשי</p><p>+6 = 1647 יום שני</p><p>+6 = 1653 יום ראשון</p><p>+ שנה = יום ששי [ראש השנה 1654]</p><p>+שנה = יום שני [ראש השנה 1655]</p><p>+שנה = יום חמשי [ראש השנה 1656]</p><p>יום שבת בראש החודש השני</p><p>יום שבת בחמשה-עשר לחודש</p><p>יום שני בשבעה-עשר לחודש השני</p><p>בראשית ז11: </p><p>&quot;בִּשְׁנַת שֵׁשׁ מֵאוֹת שָׁנָה לְחַיֵּי נֹחַ בַּחֹדֶשׁ הַשֵּׁנִי בְּשִׁבְעָה עָשָׂר יוֹם לַחֹדֶשׁ בַּיּוֹם הַזֶּה נִבְקְעוּ כָּל מעינות תְּהוֹם רַבָּה וַאֲרֻבֹּת הַשָּׁמַיִם נִפְתָּחוּ&quot;</p><p>בראשית ז12: &quot;וַיְהִי הַגֶּשֶׁם עַל הָאָרֶץ אַרְבָּעִים יוֹם וְאַרְבָּעִים לָיְלָה&quot;</p><p>17 לחודש השלשי = יום רבעי </p><p>27 לחודש השלשי = יום שבת  [הוא יום הארבעים למבול]</p><p>17 לחודש הרבעי = יום ששי</p><p>17 לחודש החמשי = יום ראשון</p><p>17 לחודש הששי = יום שלשי</p><p>17 לחודש השבעי = יום חמשי</p><p>בראשית ח4: &quot;וַתָּנַח הַתֵּבָה בַּחֹדֶשׁ הַשְּׁבִיעִי בְּשִׁבְעָה עָשָׂר יוֹם לַחֹדֶשׁ עַל הָרֵי אֲרָרָט&quot;</p><p>17 לחודש השמני = יום שבת</p><p>17 לחודש התשעי = יום שני</p><p>17 לחודש העשירי = יום רבעי</p><p>15 לחודש העשירי = יום שני</p><p>ראש החודש העשירי =ביום שני</p><p>בראשית ח5: &quot;וְהַמַּיִם הָיוּ הָלוֹךְ וְחָסוֹר עַד הַחֹדֶשׁ הָעֲשִׂירִי בָּעֲשִׂירִי בְּאֶחָד לַחֹדֶשׁ נִרְאוּ רָאשֵׁי הֶהָרִים&quot;</p><p>ראש החודש האחד-עשר = ביום רבעי</p><p>ראש החודש השנים-עשר = ביום ששי</p><p>ראש החודש הראשון = ביום ראשון לשבוע</p><p>בראשית ח13: </p><p>&quot;וַיְהִי בְּאַחַת וְשֵׁשׁ מֵאוֹת שָׁנָה בָּרִאשׁוֹן בְּאֶחָד לַחֹדֶשׁ חָרְבוּ הַמַּיִם מֵעַל הָאָרֶץ וַיָּסַר נֹחַ אֶת מִכְסֵה הַתֵּבָה וַיַּרְא וְהִנֵּה חָרְבוּ פְּנֵי הָאֲדָמָה&quot;</p>',
		'https://www.google.com/accounts/o8/id?id=AItOawkimwFyqevXh2gjrVPHX9qj0eFdlDWJLww',
		'Daian Moshe',
		'2015-04-03 12:53:16'
		)
...
SET character_set_connection=utf8;
		...
		INSERT INTO tguvot (parent,body,userid,username,created_at) VALUES (
		'tnk1/messages/prqim_t0108_1.html',
		'<p>שנת 1617 = 33 יובלים כפול 49 [מחזור שנת יובל]</p><p>+6 = 1623 יום ששי</p><p>+6 = 1629 יום חמשי</p><p>+6 = 1635 יום רבעי</p><p>+6 = 1641 יום שלשי</p><p>+6 = 1647 יום שני</p><p>+6 = 1653 יום ראשון</p><p>+ שנה = יום ששי [ראש השנה 1654]</p><p>+שנה = יום שני [ראש השנה 1655]</p><p>+שנה = יום חמשי [ראש השנה 1656]</p><p>יום שבת בראש החודש השני</p><p>יום שבת בחמשה-עשר לחודש</p><p>יום שני בשבעה-עשר לחודש השני</p><p>בראשית ז11:</p><p>&quot;בִּשְׁנַת שֵׁשׁ מֵאוֹת שָׁנָה לְחַיֵּי נֹחַ בַּחֹדֶשׁ הַשֵּׁנִי בְּשִׁבְעָה עָשָׂר יוֹם לַחֹדֶשׁ בַּיּוֹם הַזֶּה נִבְקְעוּ כָּל מעינות תְּהוֹם רַבָּה וַאֲרֻבֹּת הַשָּׁמַיִם נִפְתָּחוּ&quot;</p><p>בראשית ז12: &quot;וַיְהִי הַגֶּשֶׁם עַל הָאָרֶץ אַרְבָּעִים יוֹם וְאַרְבָּעִים לָיְלָה&quot;</p><p>17 לחודש השלשי = יום רבעי</p><p>27 לחודש השלשי = יום שבת [הוא יום הארבעים למבול]</p><p>17 לחודש הרבעי = יום ששי</p><p>17 לחודש החמשי = יום ראשון</p><p>17 לחודש הששי = יום שלשי</p><p>17 לחודש השבעי = יום חמשי</p><p>בראשית ח4: &quot;וַתָּנַח הַתֵּבָה בַּחֹדֶשׁ הַשְּׁבִיעִי בְּשִׁבְעָה עָשָׂר יוֹם לַחֹדֶשׁ עַל הָרֵי אֲרָרָט&quot;</p><p>17 לחודש השמני = יום שבת</p><p>17 לחודש התשעי = יום שני</p><p>17 לחודש העשירי = יום רבעי</p><p>15 לחודש העשירי = יום שני</p><p>ראש החודש העשירי =ביום שני</p><p>בראשית ח5: &quot;וְהַמַּיִם הָיוּ הָלוֹךְ וְחָסוֹר עַד הַחֹדֶשׁ הָעֲשִׂירִי בָּעֲשִׂירִי בְּאֶחָד לַחֹדֶשׁ נִרְאוּ רָאשֵׁי הֶהָרִים&quot;</p><p>ראש החודש האחד-עשר = ביום רבעי</p><p>ראש החודש השנים-עשר = ביום ששי</p><p>ראש החודש הראשון לשנת 1657 = ביום ראשון לשבוע</p><p>בראשית ח13:</p><p>&quot;וַיְהִי בְּאַחַת וְשֵׁשׁ מֵאוֹת שָׁנָה בָּרִאשׁוֹן בְּאֶחָד לַחֹדֶשׁ חָרְבוּ הַמַּיִם מֵעַל הָאָרֶץ וַיָּסַר נֹחַ אֶת מִכְסֵה הַתֵּבָה וַיַּרְא וְהִנֵּה חָרְבוּ פְּנֵי הָאֲדָמָה&quot;</p>',
		'https://www.google.com/accounts/o8/id?id=AItOawkimwFyqevXh2gjrVPHX9qj0eFdlDWJLww',
		'Daian Moshe',
		'2015-04-03 12:59:19'
		)
...
SET character_set_connection=utf8;
			...
			UPDATE tguvot 
			SET deleted_at='2015-04-03 12:59:49' 
			WHERE messageid=5202;
...
SET character_set_connection=utf8;
		...
		INSERT INTO tguvot (parent,body,userid,username,created_at) VALUES (
		'tnk1/messages/prqim_t0101_23.html',
		'<p>ביום ששי בתאריך 20.3.2015 היה ליקוי חמה </p><p>ליקוי החמה המעיד על מחצית החודש בחמישה-עשר לחודש בַּכֵּסֶה לְיוֹם חַגֵּנוּ [חַג הַמַּצּוֹת זה היה]</p><p>וכעבור שבועיים ויום = ביום שבת בתאריך 4.4.2015 היה ליקוי ירח</p><p>ליקוי ירח מעיד על ראש החודש [הוא האחד לחודש השני]</p><p> http://www.ynet.co.il/articles/0,7340,L-4644180,00.html</p>',
		'https://www.google.com/accounts/o8/id?id=AItOawkimwFyqevXh2gjrVPHX9qj0eFdlDWJLww',
		'Daian Moshe',
		'2015-04-04 17:57:45'
		)
...
SET character_set_connection=utf8;
			...
			UPDATE tguvot 
			SET deleted_at='2015-04-04 18:34:39' 
			WHERE messageid=2552;
...
SET character_set_connection=utf8;
		...
		INSERT INTO tguvot (parent,body,userid,username,created_at) VALUES (
		'tnk1/messages/prqim_t0518_3.html',
		'<p>&quot;יצהר הוא עמינדב&quot;?!</p><p>הרי נאמר בפירוש שיצהר הוא &quot;בֶּן קְהָת&quot;, וקהת הוא &quot;בֶּן לֵוִי&quot;! </p>',
		'https://www.google.com/accounts/o8/id?id=AItOawn-lsCU8_iWlz8S04hKIj7ekaBSyZaEloo',
		'Erel Segal Halevi',
		'2015-04-04 18:54:56'
		)
...
SET character_set_connection=utf8;
		...
		INSERT INTO tguvot (parent,body,userid,username,created_at) VALUES (
		'tnk1/messages/prqim_t0518_3.html',
		'<p>אראל ידידי קרא נא בקישור ותראה כי אכן יצהר הוא עמינדב</p><p>http://tora.us.fm/tnk1/messages/prqim_t0206_5.html</p>',
		'https://www.google.com/accounts/o8/id?id=AItOawkimwFyqevXh2gjrVPHX9qj0eFdlDWJLww',
		'Daian Moshe',
		'2015-04-05 04:27:55'
		)
...
SET character_set_connection=utf8;
		...
		INSERT INTO tguvot (parent,body,userid,username,created_at) VALUES (
		'tnk1/tora/dvrim/dm-18-0102.html',
		'<p>דברים יח1: &quot; לֹא יִהְיֶה לַכֹּהֲנִים הַלְוִיִּם כָּל שֵׁבֶט לֵוִי חֵלֶק וְנַחֲלָה עִם יִשְׂרָאֵל אִשֵּׁי יהוה וְנַחֲלָתוֹ יֹאכֵלוּן &quot;.</p><p>דברים יח2: &quot; וְנַחֲלָה לֹא יִהְיֶה לּוֹ בְּקֶרֶב אֶחָיו יהוה הוּא נַחֲלָתוֹ כַּאֲשֶׁר דִּבֶּר לוֹ &quot;.</p><p>פרוש לבאר:</p><p>כי לבני ישראל יהיו שדות מטעים וכרמים אך לֹא יִהְיֶה לַכֹּהֲנִים הַלְוִיִּם כָּל שֵׁבֶט לֵוִי שדות מטעים וכרמים</p><p>אִשֵּׁי יהוה וְנַחֲלָתוֹ יֹאכֵלוּן לאמור כי לבני לוי יכול להיות רק עדרי צאן ובקר לאכול משם אִשֵּׁי יהוה וְנַחֲלָתוֹ </p><p>כאשר גם הבל היה רועה צאן ולא הייתה לו אדמה כאשר לקין אחיו</p><p>כי פרי האדמה לאדם ולבני האלהים אִשֵּׁי יהוה וְנַחֲלָתוֹ יֹאכֵלוּן </p><p>וגם בני רכב נהגו כבני לוי על כן בייתה להם ברכת אלהים </p><p>ספר ירמיהו פרק לה כתוב:</p><p>א: הדבר אשר היה אל ירמיהו מאת יהוה בימי יהויקים בן יאשיהו מלך יהודה לאמר</p><p>ב: הלוך אל בית הרכבים ודברת אותם והבאותם בית יהוה אל אחת הלשכות והשקית אותם יין</p><p>ג: ואקח את יאזניה בן ירמיהו בן חבצניה ואת אחיו ואת כל בניו ואת כל בית הרכבים</p><p>ד: ואבא אתם בית יהוה אל לשכת בני חנן בן יגדליהו איש האלהים אשר אצל לשכת השרים אשר ממעל ללשכת מעשיהו בן שלם שמר הסף</p><p>ה: ואתן לפני בני בית הרכבים גבעים מלאים יין וכסות ואמר אליהם שתו יין</p><p>ו: ויאמרו לא נשתה יין כי יונדב בן רכב אבינו צוה עלינו לאמר לא תשתו יין אתם ובניכם עד עולם</p><p>ז: ובית לא תבנו וזרע לא תזרעו וכרם לא תטעו ולא יהיה לכם כי באהלים תשבו כל ימיכם למען תחיו ימים רבים על פני האדמה אשר אתם גרים שם</p><p>ח: ונשמע בקול יהונדב בן רכב אבינו לכל אשר צונו לבלתי שתות יין כל ימינו אנחנו נשינו בנינו ובנתינו</p><p>ט: ולבלתי בנות בתים לשבתנו וכרם ושדה וזרע לא יהיה לנו</p><p>במדבר לה3: &quot;וְהָיוּ הֶעָרִים לָהֶם לָשָׁבֶת וּמִגְרְשֵׁיהֶם יִהְיוּ לִבְהֶמְתָּם וְלִרְכֻשָׁם וּלְכֹל חַיָּתָם&quot;</p><p>לִבְהֶמְתָּם וְלִרְכֻשָׁם וּלְכֹל חַיָּתָם ולא שדות מטעים וכרמים ולא מַטָּעֵי כָרֶם המיועדים לאנשי האדמה</p><p>בראשית ט20: &quot;וַיָּחֶל נֹחַ אִישׁ הָאֲדָמָה וַיִּטַּע כָּרֶם&quot; אך בטרם נטע כרם היה נח איש אלהים המתהלך את האלהים כבני לוי </p>',
		'https://www.google.com/accounts/o8/id?id=AItOawkimwFyqevXh2gjrVPHX9qj0eFdlDWJLww',
		'Daian Moshe',
		'2015-04-05 04:52:01'
		)
...
SET character_set_connection=utf8;
		...
		INSERT INTO tguvot (parent,body,userid,username,created_at) VALUES (
		'tnk1/tora/dvrim/dm-18-0102.html',
		'<p>דברים יח1: &quot; לֹא יִהְיֶה לַכֹּהֲנִים הַלְוִיִּם כָּל שֵׁבֶט לֵוִי חֵלֶק וְנַחֲלָה עִם יִשְׂרָאֵל אִשֵּׁי יהוה וְנַחֲלָתוֹ יֹאכֵלוּן &quot;.</p><p>דברים יח2: &quot; וְנַחֲלָה לֹא יִהְיֶה לּוֹ בְּקֶרֶב אֶחָיו יהוה הוּא נַחֲלָתוֹ כַּאֲשֶׁר דִּבֶּר לוֹ &quot;.</p><p>פרוש לבאר:</p><p>כי לבני ישראל יהיו שדות מטעים וכרמים אך לֹא יִהְיֶה לַכֹּהֲנִים הַלְוִיִּם כָּל שֵׁבֶט לֵוִי שדות מטעים וכרמים</p><p>אִשֵּׁי יהוה וְנַחֲלָתוֹ יֹאכֵלוּן לאמור כי לבני לוי יכול להיות רק עדרי צאן ובקר לאכול משם אִשֵּׁי יהוה וְנַחֲלָתוֹ </p><p>כאשר גם הבל היה רועה צאן ולא הייתה לו אדמה כאשר לקין אחיו</p><p>כי פרי האדמה לאדם ולבני האלהים אִשֵּׁי יהוה וְנַחֲלָתוֹ יֹאכֵלוּן </p><p>וגם בני רכב נהגו כבני לוי על כן הייתה להם ברכת אלהים </p><p>ספר ירמיהו פרק לה כתוב:</p><p>א: הדבר אשר היה אל ירמיהו מאת יהוה בימי יהויקים בן יאשיהו מלך יהודה לאמר</p><p>ב: הלוך אל בית הרכבים ודברת אותם והבאותם בית יהוה אל אחת הלשכות והשקית אותם יין</p><p>ג: ואקח את יאזניה בן ירמיהו בן חבצניה ואת אחיו ואת כל בניו ואת כל בית הרכבים</p><p>ד: ואבא אתם בית יהוה אל לשכת בני חנן בן יגדליהו איש האלהים אשר אצל לשכת השרים אשר ממעל ללשכת מעשיהו בן שלם שמר הסף</p><p>ה: ואתן לפני בני בית הרכבים גבעים מלאים יין וכסות ואמר אליהם שתו יין</p><p>ו: ויאמרו לא נשתה יין כי יונדב בן רכב אבינו צוה עלינו לאמר לא תשתו יין אתם ובניכם עד עולם</p><p>ז: ובית לא תבנו וזרע לא תזרעו וכרם לא תטעו ולא יהיה לכם כי באהלים תשבו כל ימיכם למען תחיו ימים רבים על פני האדמה אשר אתם גרים שם</p><p>ח: ונשמע בקול יהונדב בן רכב אבינו לכל אשר צונו לבלתי שתות יין כל ימינו אנחנו נשינו בנינו ובנתינו</p><p>ט: ולבלתי בנות בתים לשבתנו וכרם ושדה וזרע לא יהיה לנו</p><p>במדבר לה3: &quot;וְהָיוּ הֶעָרִים לָהֶם לָשָׁבֶת וּמִגְרְשֵׁיהֶם יִהְיוּ לִבְהֶמְתָּם וְלִרְכֻשָׁם וּלְכֹל חַיָּתָם&quot;</p><p>לִבְהֶמְתָּם וְלִרְכֻשָׁם וּלְכֹל חַיָּתָם ולא שדות מטעים וכרמים ולא מַטָּעֵי כָרֶם המיועדים לאנשי האדמה</p><p>בראשית ט20: &quot;וַיָּחֶל נֹחַ אִישׁ הָאֲדָמָה וַיִּטַּע כָּרֶם&quot; אך בטרם נטע כרם היה נח איש אלהים המתהלך את האלהים כבני לוי </p>',
		'https://www.google.com/accounts/o8/id?id=AItOawkimwFyqevXh2gjrVPHX9qj0eFdlDWJLww',
		'Daian Moshe',
		'2015-04-05 04:53:41'
		)
...
SET character_set_connection=utf8;
			...
			UPDATE tguvot 
			SET deleted_at='2015-04-05 04:53:45' 
			WHERE messageid=5207;
...
SET character_set_connection=utf8;
		...
		INSERT INTO tguvot (parent,body,userid,username,created_at) VALUES (
		'tnk1/tora/dvrim/dm-18-0102.html',
		'<p>דברים יח1: &quot; לֹא יִהְיֶה לַכֹּהֲנִים הַלְוִיִּם כָּל שֵׁבֶט לֵוִי חֵלֶק וְנַחֲלָה עִם יִשְׂרָאֵל אִשֵּׁי יהוה וְנַחֲלָתוֹ יֹאכֵלוּן &quot;.</p><p>דברים יח2: &quot; וְנַחֲלָה לֹא יִהְיֶה לּוֹ בְּקֶרֶב אֶחָיו יהוה הוּא נַחֲלָתוֹ כַּאֲשֶׁר דִּבֶּר לוֹ &quot;.</p><p>פרוש לבאר:</p><p>כי לבני ישראל יהיו שדות מטעים וכרמים אך לֹא יִהְיֶה לַכֹּהֲנִים הַלְוִיִּם כָּל שֵׁבֶט לֵוִי שדות מטעים וכרמים</p><p>אִשֵּׁי יהוה וְנַחֲלָתוֹ יֹאכֵלוּן לאמור כי לבני לוי יכול להיות רק עדרי צאן ובקר לאכול משם אִשֵּׁי יהוה וְנַחֲלָתוֹ</p><p>כאשר גם הבל היה רועה צאן ולא הייתה לו אדמה כאשר לקין אחיו</p><p>כי פרי האדמה לאדם ולבני האלהים אִשֵּׁי יהוה וְנַחֲלָתוֹ יֹאכֵלוּן</p><p>וגם בני רכב נהגו כבני לוי על כן הייתה להם ברכת אלהים</p><p>ספר ירמיהו פרק לה כתוב:</p><p>א: הדבר אשר היה אל ירמיהו מאת יהוה בימי יהויקים בן יאשיהו מלך יהודה לאמר</p><p>ב: הלוך אל בית הרכבים ודברת אותם והבאותם בית יהוה אל אחת הלשכות והשקית אותם יין</p><p>ג: ואקח את יאזניה בן ירמיהו בן חבצניה ואת אחיו ואת כל בניו ואת כל בית הרכבים</p><p>ד: ואבא אתם בית יהוה אל לשכת בני חנן בן יגדליהו איש האלהים אשר אצל לשכת השרים אשר ממעל ללשכת מעשיהו בן שלם שמר הסף</p><p>ה: ואתן לפני בני בית הרכבים גבעים מלאים יין וכסות ואמר אליהם שתו יין</p><p>ו: ויאמרו לא נשתה יין כי יונדב בן רכב אבינו צוה עלינו לאמר לא תשתו יין אתם ובניכם עד עולם</p><p>ז: ובית לא תבנו וזרע לא תזרעו וכרם לא תטעו ולא יהיה לכם כי באהלים תשבו כל ימיכם למען תחיו ימים רבים על פני האדמה אשר אתם גרים שם</p><p>ח: ונשמע בקול יהונדב בן רכב אבינו לכל אשר צונו לבלתי שתות יין כל ימינו אנחנו נשינו בנינו ובנתינו</p><p>ט: ולבלתי בנות בתים לשבתנו וכרם ושדה וזרע לא יהיה לנו</p><p>במדבר לה3: &quot;וְהָיוּ הֶעָרִים לָהֶם לָשָׁבֶת וּמִגְרְשֵׁיהֶם יִהְיוּ לִבְהֶמְתָּם וְלִרְכֻשָׁם וּלְכֹל חַיָּתָם&quot;</p><p>לִבְהֶמְתָּם וְלִרְכֻשָׁם וּלְכֹל חַיָּתָם ולא שדות מטעים וכרמים ולא מַטָּעֵי כָרֶם המיועדים לאנשי האדמה</p><p>בראשית ט20: &quot;וַיָּחֶל נֹחַ אִישׁ הָאֲדָמָה וַיִּטַּע כָּרֶם&quot; אך בטרם נטע כרם היה נח איש אלהים המתהלך את האלהים כבני לוי</p><p>ישעיהו כח7: &quot;וְגַם אֵלֶּה בַּיַּיִן שָׁגוּ וּבַשֵּׁכָר תָּעוּ כֹּהֵן וְנָבִיא שָׁגוּ בַשֵּׁכָר נִבְלְעוּ מִן הַיַּיִן תָּעוּ מִן הַשֵּׁכָר שָׁגוּ בָּרֹאֶה פָּקוּ פְּלִילִיָּה&quot; </p><p>הושע ד7: &quot;כְּרֻבָּם כֵּן חָטְאוּ לִי כְּבוֹדָם בְּקָלוֹן אָמִיר&quot;</p>',
		'https://www.google.com/accounts/o8/id?id=AItOawkimwFyqevXh2gjrVPHX9qj0eFdlDWJLww',
		'Daian Moshe',
		'2015-04-05 05:20:12'
		)
...
SET character_set_connection=utf8;
			...
			UPDATE tguvot 
			SET deleted_at='2015-04-05 05:20:41' 
			WHERE messageid=5208;
...
SET character_set_connection=utf8;
		...
		INSERT INTO tguvot (parent,body,userid,username,created_at) VALUES (
		'tnk1/tora/dvrim/dm-18-0102.html',
		'<p>יפה</p><p>אבל בתורה לא נאמר שאסור לבן-לוי לשתול כרם...</p><p>הוא יכול לשתול כרם גם בגינה שליד הבית בעיר הלויים.</p>',
		'https://www.google.com/accounts/o8/id?id=AItOawn-lsCU8_iWlz8S04hKIj7ekaBSyZaEloo',
		'Erel Segal Halevi',
		'2015-04-05 06:41:15'
		)
...
SET character_set_connection=utf8;
		...
		INSERT INTO tguvot (parent,body,userid,username,created_at) VALUES (
		'tnk1/tora/dvrim/dm-18-0102.html',
		'<p>איש אלהים רֹעֵה צֹאן שומר על בשר הבהמה הטהורה אשר היא לחם האלהים וממנה להקריב אִשֵּׁי יהוה וְנַחֲלָתוֹ</p><p>ואם אִישׁ הָאֲדָמָה וַיִּטַּע כָּרֶם &quot;וַיֵּשְׁתְּ מִן הַיַּיִן וַיִּשְׁכָּר וַיִּתְגַּל בְּתוֹךְ אָהֳלֹה&quot;</p><p>משלי לא4: &quot;אַל לַמְלָכִים לְמוֹאֵל אַל לַמְלָכִים שְׁתוֹ יָיִן וּלְרוֹזְנִים או[אֵי] שֵׁכָר&quot;</p><p>שמות יט6: &quot;וְאַתֶּם תִּהְיוּ לִי מַמְלֶכֶת כֹּהֲנִים וְגוֹי קָדוֹשׁ אֵלֶּה הַדְּבָרִים אֲשֶׁר תְּדַבֵּר אֶל בְּנֵי יִשְׂרָאֵל&quot;</p><p>דברים יח1:  לַכֹּהֲנִים הַלְוִיִּם = כָּל שֵׁבֶט לֵוִי</p><p>מלאכי ג3: &quot;וְיָשַׁב מְצָרֵף וּמְטַהֵר כֶּסֶף וְטִהַר אֶת בְּנֵי לֵוִי וְזִקַּק אֹתָם כַּזָּהָב וְכַכָּסֶף וְהָיוּ ליהוה מַגִּישֵׁי מִנְחָה בִּצְדָקָה&quot;</p><p>  וְטִהַר אֶת בְּנֵי לֵוִי = אַל תִּשְׁתִּי יַיִן וְשֵׁכָר וְאַל תֹּאכְלִי כָּל טֻמְאָה</p><p>שופטים יג7: &quot;וַיֹּאמֶר לִי הִנָּךְ הָרָה וְיֹלַדְתְּ בֵּן וְעַתָּה אַל תִּשְׁתִּי יַיִן וְשֵׁכָר וְאַל תֹּאכְלִי כָּל טֻמְאָה כִּי נְזִיר אֱלֹהִים יִהְיֶה הַנַּעַר מִן הַבֶּטֶן עַד יוֹם מוֹתוֹ&quot;</p><p> נְזִיר אֱלֹהִים = הוא הכהן הגדול נזר אלהים קדוש יהוה</p>',
		'https://www.google.com/accounts/o8/id?id=AItOawkimwFyqevXh2gjrVPHX9qj0eFdlDWJLww',
		'Daian Moshe',
		'2015-04-05 08:32:29'
		)
...
SET character_set_connection=utf8;
			...
			UPDATE tguvot 
			SET deleted_at='2015-04-05 08:46:08' 
			WHERE messageid=5211;

SET character_set_client=utf8;
SET character_set_connection=utf8;

		INSERT INTO tguvot (parent,body,userid,username,created_at) VALUES (
		'tnk1/sofrim/zuckm/plpul.html',
		'<p>עבודה תמציתית ויפה יישר כוח !</p>',
		'https://www.google.com/accounts/o8/id?id=AItOawlNsutXNQ8bOUi8XojrMMrQeNXhwIgPx94',
		'שמואל קטן',
		'2015-04-05 22:52:06'
		)
		;
...
SET character_set_connection=utf8;
		...
		INSERT INTO tguvot (parent,body,userid,username,created_at) VALUES (
		'tnk1/kma/qjrim1/cr_li_mod.html',
		'<p>רעב ודבר הם מכות משמיים, חרב זו מכת אדם, דוד שולל את עונש החרב, &quot;וביד אדם אל אפולה&quot;, נשארו שתי מכות, רעב או דבר, לדוד קשה לבחור רעב או דבר לעמו, הוא מעדיף שהרחמן יבחר כי רבים רחמיו, &quot;נפלה נא ביד ד\' כי רבים רחמיו&quot;, נבואת גד הנביא מציגה את מידת הדין, הרחמן ממתיק את הדין במידת הרחמים. </p><p> </p><p> גם הנביא ישעיה מתנבא לחזקיה במידת הדין, &quot;צו לביתך כי מת אתה ולא תחיה&quot;, יתר על כן, הנביא ישעיה גם מתנגד ומסרב לתת לו את בתו לאישה, ואומר לו שכבר נגזרה גזירה שימות, זו מידת הדין, המלך חזקיה עונה לו, &quot;בן אמוץ כלה נבואתך וצא, כך מקובלני מבית אבי אבא, אפילו חרב חדה מונחת על צווארו של אדם אל ימנע עצמו מן הרחמים, האם דברי המלך חזקיה מתיחסים לדברי דוד המלך? &quot;נפלה נא ביד ד\' כי רבים רחמיו&quot; </p><p> </p><p> גם בנבואת ירמיהו רואים את מידת הדין, &quot;ואמרתי לא אזכרנו ולא אדבר עוד בשמו והיה בלבי כאש בוערת עצור בעצמותי ונלאיתי כלכל ולא אוכל&quot;, זו מידת הדין הקשה גם לנביא עצמו, והוא מתנבא, &quot;אסוף אסיפם נאום ד\' אין ענבים בגפן ואין תאנים בתאנה והעלה נבל ואתן להם יעברום, על מה אנחנו יושבים האספו ונבוא אל ערי המבצר ונדמה שם כי ד\' אלוקינו הדמנו וישקנו מי ראש כי חטאנו לד\', קוה לשלום ואין טוב לעת מרפה והנה בעתה&quot;, ומה כאן מידת הרחמים? &quot;גלו לבבל שכינה עמהם, שנאמר, למענכם שולחתי בבלה&quot;, ויעידו על זאת מרדכי ואסתר, והתלמוד הבבלי. </p><p>   </p><p> גם בחטא העגל, באה הנבואה למשה במידת הדין, מרע&quot;ה מתפלל וממתיק את הדין למידת הרחמים, ממנו קיבלנו את י&quot;ג מידות הרחמים ליום הכיפורים, זכותו תעמוד לנו, אמן</p>',
		'https://www.google.com/accounts/o8/id?id=AItOawnQjFUl4VEqbDGptZPJ-VKdrHUDrxKYHw4',
		'Sasson Scharphie',
		'2015-04-06 01:37:38'
		)
...
SET character_set_connection=utf8;
		...
		INSERT INTO tguvot (parent,body,userid,username,created_at) VALUES (
		'tnk1/kma/qjrim1/cr_li_mod.html',
		'<p>כֹּה אָמַר יְהוָה: שָׁלֹשׁ אָנֹכִי נוֹטֵל עָלֶיך בְּחַר לְךָ אַחַת מֵהֶם וְאֶעֱשֶׂה לָּךְ. </p><p>יג וַיָּבֹא גָד אֶל דָּוִד וַיַּגֶּד לוֹ וַיֹּאמֶר לוֹ: </p><p>הֲתָבוֹא לְךָ שֶׁבַע שָׁנִים רָעָב בְּאַרְצֶךָ </p><p>אִם שְׁלֹשָׁה חֳדָשִׁים נֻסְךָ לִפְנֵי צָרֶיךָ וְהוּא רֹדְפֶךָ </p><p>וְאִם הֱיוֹת שְׁלֹשֶׁת יָמִים דֶּבֶר בְּאַרְצֶךָ עַתָּה דַּע וּרְאֵה מָה אָשִׁיב שֹׁלְחִי דָּבָר.</p><p>--------------------------------------------------------------------------------</p><p>קודם תבין אראל שבע שנות רעב ולא שלוש</p><p>כל שלשת המכות מהאלהים </p><p>ודבר היא המכה הישירה מאלהים [כי דבר זה סרטן ובתהליך מחלה זאת באופן יחסי רבים רחמי אלהים וגם הרופאים יעידו ויגידו זאת]</p><p>כי רעב זה מהארץ [וגם כי כי אם יהיה רעב ומצוקה כלכלית ועוני כבד אז העם יתמרמר וילחם בדוד והוא לא רצה ליפול בידי אדם]</p><p>וחרב זה מאויבים</p>',
		'https://www.google.com/accounts/o8/id?id=AItOawkimwFyqevXh2gjrVPHX9qj0eFdlDWJLww',
		'Daian Moshe',
		'2015-04-06 04:44:28'
		)
...
SET character_set_connection=utf8;
		...
		INSERT INTO tguvot (parent,body,userid,username,created_at) VALUES (
		'tnk1/messages/kma_qjrim2_mikl_0.html',
		'<p>I hope you get this not sure if you will .send me back if you do thanks.</p>',
		'https://www.google.com/accounts/o8/id?id=AItOawmmMYyS-VdLUDNvon_fTP6i5rMVomL7wWE',
		'tom guns',
		'2015-04-06 06:24:26'
		)
		;
...
SET character_set_connection=utf8;
		...
		'<p> יחזקאל מה3: &quot;וּמִן הַמִּדָּה הַזֹּאת תָּמוֹד אֹרֶךְ חמש[חֲמִשָּׁה] וְעֶשְׂרִים אֶלֶף וְרֹחַב עֲשֶׂרֶת אֲלָפִים וּבוֹ יִהְיֶה הַמִּקְדָּשׁ קֹדֶשׁ קָדָשִׁים&quot;</p><p>יחזקאל מה4: &quot;קֹדֶשׁ מִן הָאָרֶץ הוּא לַכֹּהֲנִים מְשָׁרְתֵי הַמִּקְדָּשׁ יִהְיֶה הַקְּרֵבִים לְשָׁרֵת אֶת יהוה וְהָיָה לָהֶם מָקוֹם לְבָתִּים וּמִקְדָּשׁ לַמִּקְדָּשׁ&quot;</p><p>וּמִקְדָּשׁ לַמִּקְדָּשׁ = וּמִקְדָּשׁ נחלת הארץ לַמִּקְדָּשׁ משכן הכהנים</p><p>באור לפרש:</p><p>הראש מלשון ראשון הוא הצאקרה הראשונה ולא האחרונה</p><p>[הר חרמון הוא העינים של המדינה בראש בצפון]</p><p>והערווה היא הצאקרה האחרונה הצאקרה השביעית בדרום</p><p>הר חברון נחלת הקודש של הר יהודה הנחלה השביעית  *******</p><p>עיין ספר יחזקאל פרק מח ככתוב:</p><p>(א) וְאֵלֶּה שְׁמוֹת הַשְּׁבָטִים מִקְצֵה צָפוֹנָה אֶל יַד דֶּרֶךְ חֶתְלֹן לְבוֹא חֲמָת חֲצַר עֵינָן גְּבוּל דַּמֶּשֶׂק צָפוֹנָה אֶל יַד חֲמָת וְהָיוּ לוֹ פְאַת קָדִים הַיָּם דָּן אֶחָד.</p><p>(ב) וְעַל גְּבוּל דָּן מִפְּאַת קָדִים עַד פְּאַת יָמָּה אָשֵׁר אֶחָד.</p><p>(ג) וְעַל גְּבוּל אָשֵׁר מִפְּאַת קָדִימָה וְעַד פְּאַת יָמָּה נַפְתָּלִי אֶחָד.</p><p>(ד) וְעַל גְּבוּל נַפְתָּלִי מִפְּאַת קָדִמָה עַד פְּאַת יָמָּה מְנַשֶּׁה אֶחָד.</p><p>(ה) וְעַל גְּבוּל מְנַשֶּׁה מִפְּאַת קָדִמָה עַד פְּאַת יָמָּה אֶפְרַיִם אֶחָד.</p><p>(ו) וְעַל גְּבוּל אֶפְרַיִם מִפְּאַת קָדִים וְעַד פְּאַת יָמָּה רְאוּבֵן אֶחָד.</p><p>(ז) וְעַל גְּבוּל רְאוּבֵן מִפְּאַת קָדִים עַד פְּאַת יָמָּה יְהוּדָה אֶחָד.</p><p>הר יהודה [אותיות יהוה] הוא הנחלה השביעית נחלת הקודש</p><p>אראל סגל הלוי שאל מדוע הכהנים לא יקבלו ערים מפוזרות בתוך שבטי ישראל, כפי שהיה בימי בית ראשון, אלא נחלה אחת מרוכזת?</p><p>כדי שהכהנים הקדושים בנחלה השבעית נחלת הקודש  לא יטמאו בתוך עם ישראל</p><p>ספר ויקרא פרק כא כתוב:</p><p>א: ויאמר יהוה אל משה אמר אל הכהנים בני אהרן ואמרת אלהם לנפש לא יטמא בעמיו</p><p>ב: כי אם לשארו הקרב אליו לאמו ולאביו ולבנו ולבתו ולאחיו</p><p>ג: ולאחתו הבתולה הקרובה אליו אשר לא היתה לאיש לה יטמא</p><p>ד: לא יטמא בעל בעמיו להחלו</p><p>כי אם איש רוח אלהים קדושים אני וחפצתי לשבת עם אַחַי הִנֵּה מַה טּוֹב וּמַה נָּעִים שֶׁבֶת אַחִים גַּם יָחַד </p><p> הִנֵּה מַה טּוֹב וּמַה נָּעִים שֶׁבֶת לי עם הכהנים הקדושים להבדל מֵעַמֵּי הָאָרֶץ פן אחלל קודש אלהים</p><p>ישעיהו ו5: &quot;וָאֹמַר אוֹי לִי כִּי נִדְמֵיתִי כִּי אִישׁ טְמֵא שְׂפָתַיִם אָנֹכִי וּבְתוֹךְ עַם טְמֵא שְׂפָתַיִם אָנֹכִי יוֹשֵׁב כִי אֶת הַמֶּלֶךְ יהוה צְבָאוֹת רָאוּ עֵינָי&quot;</p><p>במדבר ח14: &quot;וְהִבְדַּלְתָּ אֶת הַלְוִיִּם מִתּוֹךְ בְּנֵי יִשְׂרָאֵל וְהָיוּ לִי הַלְוִיִּם&quot;</p>',
		'https://www.google.com/accounts/o8/id?id=AItOawkimwFyqevXh2gjrVPHX9qj0eFdlDWJLww',
		'Daian Moshe',
		'2015-04-07 11:59:03'
		)
...
SET character_set_connection=utf8;
		...
		INSERT INTO tguvot (parent,body,userid,username,created_at) VALUES (
		'tnk1/nvia/yxzqel/yx-45-0306.html',
		'<p>יחזקאל מה3: &quot;וּמִן הַמִּדָּה הַזֹּאת תָּמוֹד אֹרֶךְ חמש[חֲמִשָּׁה] וְעֶשְׂרִים אֶלֶף וְרֹחַב עֲשֶׂרֶת אֲלָפִים וּבוֹ יִהְיֶה הַמִּקְדָּשׁ קֹדֶשׁ קָדָשִׁים&quot;</p><p>יחזקאל מה4: &quot;קֹדֶשׁ מִן הָאָרֶץ הוּא לַכֹּהֲנִים מְשָׁרְתֵי הַמִּקְדָּשׁ יִהְיֶה הַקְּרֵבִים לְשָׁרֵת אֶת יהוה וְהָיָה לָהֶם מָקוֹם לְבָתִּים וּמִקְדָּשׁ לַמִּקְדָּשׁ&quot;</p><p>וּמִקְדָּשׁ לַמִּקְדָּשׁ = וּמִקְדָּשׁ נחלת הארץ לַמִּקְדָּשׁ משכן הכהנים</p><p>באור לפרש:</p><p>הראש מלשון ראשון הוא הצאקרה הראשונה ולא האחרונה</p><p>[הר חרמון הוא העינים של המדינה בראש בצפון]</p><p>והערווה היא הצאקרה האחרונה הצאקרה השביעית בדרום</p><p>הר חברון נחלת הקודש של הר יהודה הנחלה השביעית *******</p><p>עיין ספר יחזקאל פרק מח ככתוב:</p><p>(א) וְאֵלֶּה שְׁמוֹת הַשְּׁבָטִים מִקְצֵה צָפוֹנָה אֶל יַד דֶּרֶךְ חֶתְלֹן לְבוֹא חֲמָת חֲצַר עֵינָן גְּבוּל דַּמֶּשֶׂק צָפוֹנָה אֶל יַד חֲמָת וְהָיוּ לוֹ פְאַת קָדִים הַיָּם דָּן אֶחָד.</p><p>(ב) וְעַל גְּבוּל דָּן מִפְּאַת קָדִים עַד פְּאַת יָמָּה אָשֵׁר אֶחָד.</p><p>(ג) וְעַל גְּבוּל אָשֵׁר מִפְּאַת קָדִימָה וְעַד פְּאַת יָמָּה נַפְתָּלִי אֶחָד.</p><p>(ד) וְעַל גְּבוּל נַפְתָּלִי מִפְּאַת קָדִמָה עַד פְּאַת יָמָּה מְנַשֶּׁה אֶחָד.</p><p>(ה) וְעַל גְּבוּל מְנַשֶּׁה מִפְּאַת קָדִמָה עַד פְּאַת יָמָּה אֶפְרַיִם אֶחָד.</p><p>(ו) וְעַל גְּבוּל אֶפְרַיִם מִפְּאַת קָדִים וְעַד פְּאַת יָמָּה רְאוּבֵן אֶחָד.</p><p>(ז) וְעַל גְּבוּל רְאוּבֵן מִפְּאַת קָדִים עַד פְּאַת יָמָּה יְהוּדָה אֶחָד.</p><p>הר יהודה [אותיות יהוה] הוא הנחלה השביעית נחלת הקודש שמה יהיה המקדש</p><p>*******************************************************************************</p><p>אראל סגל הלוי שאל מדוע הכהנים לא יקבלו ערים מפוזרות בתוך שבטי ישראל, כפי שהיה בימי בית ראשון, אלא נחלה אחת מרוכזת?</p><p>כדי שהכהנים הקדושים בנחלה השבעית נחלת הקודש לא יטמאו בתוך עם ישראל</p><p>ספר ויקרא פרק כא כתוב:</p><p>א: ויאמר יהוה אל משה אמר אל הכהנים בני אהרן ואמרת אלהם לנפש לא יטמא בעמיו</p><p>ב: כי אם לשארו הקרב אליו לאמו ולאביו ולבנו ולבתו ולאחיו</p><p>ג: ולאחתו הבתולה הקרובה אליו אשר לא היתה לאיש לה יטמא</p><p>ד: לא יטמא בעל בעמיו להחלו</p><p>כי אם איש רוח אלהים קדושים אני וחפצתי לשבת עם אַחַי הִנֵּה מַה טּוֹב וּמַה נָּעִים שֶׁבֶת אַחִים גַּם יָחַד</p><p>הִנֵּה מַה טּוֹב וּמַה נָּעִים שֶׁבֶת לי עם הכהנים הקדושים להבדל מֵעַמֵּי הָאָרֶץ פן אחלל קודש אלהים</p><p>ישעיהו ו5: &quot;וָאֹמַר אוֹי לִי כִּי נִדְמֵיתִי כִּי אִישׁ טְמֵא שְׂפָתַיִם אָנֹכִי וּבְתוֹךְ עַם טְמֵא שְׂפָתַיִם אָנֹכִי יוֹשֵׁב כִי אֶת הַמֶּלֶךְ יהוה צְבָאוֹת רָאוּ עֵינָי&quot;</p><p>במדבר ח14: &quot;וְהִבְדַּלְתָּ אֶת הַלְוִיִּם מִתּוֹךְ בְּנֵי יִשְׂרָאֵל וְהָיוּ לִי הַלְוִיִּם&quot;</p>',
		'https://www.google.com/accounts/o8/id?id=AItOawkimwFyqevXh2gjrVPHX9qj0eFdlDWJLww',
		'Daian Moshe',
		'2015-04-07 12:01:34'
		)
...
SET character_set_connection=utf8;
			...
			UPDATE tguvot 
			SET deleted_at='2015-04-07 12:02:00' 
			WHERE messageid=5225;
...
SET character_set_connection=utf8;
		...
		INSERT INTO tguvot (parent,body,userid,username,created_at) VALUES (
		'tnk1/nvia/yxzqel/yx-45-0306.html',
		'<p>אם כך, מדוע בימי בית ראשון הם קיבלו ערים מפוזרות בין שבטי ישראל?</p>',
		'https://www.google.com/accounts/o8/id?id=AItOawn-lsCU8_iWlz8S04hKIj7ekaBSyZaEloo',
		'Erel Segal Halevi',
		'2015-04-07 17:16:39'
		)
...
SET character_set_connection=utf8;
		...
		'<p>הטקסט מתוך אתר &quot;מרתון התנך&quot;, שיתקיים ביום חמישי הקרוב, ערב שביעי של פסח ה\'תשע&quot;ה: http://biblemarathon.co.il/</p>',
		'https://www.google.com/accounts/o8/id?id=AItOawn-lsCU8_iWlz8S04hKIj7ekaBSyZaEloo',
		'Erel Segal Halevi',
		'2015-04-07 18:04:49'
		)
...
SET character_set_connection=utf8;
		...
		INSERT INTO tguvot (parent,body,userid,username,created_at) VALUES (
		'tnk1/nvia/yxzqel/yx-45-0306.html',
		'<p>כה אמר יעקב לבני-לוי</p><p> בראשית מט7: &quot;אָרוּר אַפָּם כִּי עָז וְעֶבְרָתָם כִּי קָשָׁתָה אֲחַלְּקֵם בְּיַעֲקֹב וַאֲפִיצֵם בְּיִשְׂרָאֵל&quot;</p><p>ויעקב מאת אלהים אמר דברו ויש לכבד את דברי אלהים לשמוע בקולו גם אם קלל ושמעת בקולו והייתה לך ברכה </p><p>[גם אם אלהים ארר את האדמה בעבור האדם וציוה עליו להזיע כדי לאכול הלא כל מי שיזיע יציל את עצמו מכל המחלות המערביות]</p><p>כי בימי קדם לשבטי ישראל הייתה דרושה קירבה פיסית כדי ללמוד תורה מהכהן </p><p>התורה אמנם נלמדה דרך הראש ולא דרך הלב כי הכהנים הלוים נפוצו בישראל ונטמאו [ונטמעו] ולא יכלו לשמור טהרתם עד עת-קץ</p><p>מלאכי ג3: &quot;וְיָשַׁב מְצָרֵף וּמְטַהֵר כֶּסֶף וְטִהַר אֶת בְּנֵי לֵוִי וְזִקַּק אֹתָם כַּזָּהָב וְכַכָּסֶף וְהָיוּ ליהוה מַגִּישֵׁי מִנְחָה בִּצְדָקָה&quot;</p><p>ואז בדור אחרית הימים לאחר טהרת הלוים בְּנֵי לֵוִי ולא יהיו עוד אָרוּרים לחלקם ולהפיצם כי ישבו אחים גם יחד</p><p>כי באחרית הימים בדור העתיד בדור הרוחני כל מה שנדרש כדי ללמוד תורה זה קרבה רוחנית לכהן</p><p>גם אם פלמוני נמצא בארץ רחוקה הוא יכול דרך הכהן לדרש את האלהים </p><p> בדור אחרית הימים תהיה תקשורת רוחנית [יותר טובה מהאינטרנט] וכולם יוכלו לתקשר עם הכהן</p><p>מלאכי ב7: &quot;כִּי שִׂפְתֵי כֹהֵן יִשְׁמְרוּ דַעַת וְתוֹרָה יְבַקְשׁוּ מִפִּיהוּ כִּי מַלְאַךְ יהוה צְבָאוֹת הוּא&quot;</p>',
		'https://www.google.com/accounts/o8/id?id=AItOawkimwFyqevXh2gjrVPHX9qj0eFdlDWJLww',
		'Daian Moshe',
		'2015-04-07 18:40:31'
		)
...
SET character_set_connection=utf8;
		...
		INSERT INTO tguvot (parent,body,userid,username,created_at) VALUES (
		'tnk1/nvia/yxzqel/yx-45-0306.html',
		'<p>כה אמר יעקב לבני-לוי</p><p> בראשית מט7: &quot;אָרוּר אַפָּם כִּי עָז וְעֶבְרָתָם כִּי קָשָׁתָה אֲחַלְּקֵם בְּיַעֲקֹב וַאֲפִיצֵם בְּיִשְׂרָאֵל&quot;</p><p>ויעקב מאת אלהים אמר דברו ויש לכבד את דברי אלהים לשמוע בקולו גם אם קלל ושמעת בקולו והייתה לך ברכה </p><p>[גם אם אלהים ארר את האדמה בעבור האדם וציוה עליו להזיע כדי לאכול הלא כל מי שיזיע יציל את עצמו מכל המחלות המערביות]</p><p>כי בימי קדם לשבטי ישראל הייתה דרושה קירבה פיסית כדי ללמוד תורה מהכהן </p><p>התורה אמנם נלמדה דרך הראש ולא דרך הלב כי הכהנים הלוים נפוצו בישראל ונטמעו ונטמאו ולא יכלו לשמור טהרתם עד עת-קץ</p><p>מלאכי ג3: &quot;וְיָשַׁב מְצָרֵף וּמְטַהֵר כֶּסֶף וְטִהַר אֶת בְּנֵי לֵוִי וְזִקַּק אֹתָם כַּזָּהָב וְכַכָּסֶף וְהָיוּ ליהוה מַגִּישֵׁי מִנְחָה בִּצְדָקָה&quot;</p><p>ואז בדור אחרית הימים לאחר טהרת הלוים בְּנֵי לֵוִי ולא יהיו עוד אָרוּרים לחלקם ולהפיצם כי ישבו אחים גם יחד</p><p>כי באחרית הימים בדור העתיד בדור הרוחני כל מה שנדרש כדי ללמוד תורה זה קרבה רוחנית לכהן</p><p>גם אם פלמוני נמצא בארץ רחוקה הוא יכול דרך הכהן לדרש את האלהים </p><p> בדור אחרית הימים תהיה תקשורת רוחנית [יותר טובה מהאינטרנט] וכולם יוכלו לתקשר עם הכהן</p><p>מלאכי ב7: &quot;כִּי שִׂפְתֵי כֹהֵן יִשְׁמְרוּ דַעַת וְתוֹרָה יְבַקְשׁוּ מִפִּיהוּ כִּי מַלְאַךְ יהוה צְבָאוֹת הוּא&quot;</p>',
		'https://www.google.com/accounts/o8/id?id=AItOawkimwFyqevXh2gjrVPHX9qj0eFdlDWJLww',
		'Daian Moshe',
		'2015-04-07 18:42:43'
		)
...
SET character_set_connection=utf8;
			...
			UPDATE tguvot 
			SET deleted_at='2015-04-07 18:42:49' 
			WHERE messageid=5229;
...
SET character_set_connection=utf8;
		...
		INSERT INTO tguvot (parent,body,userid,username,created_at) VALUES (
		'tnk1/nvia/yxzqel/yx-45-0306.html',
		'<p>כה אמר יעקב לבני-לוי</p><p>בראשית מט7: &quot;אָרוּר אַפָּם כִּי עָז וְעֶבְרָתָם כִּי קָשָׁתָה אֲחַלְּקֵם בְּיַעֲקֹב וַאֲפִיצֵם בְּיִשְׂרָאֵל&quot;</p><p>ויעקב מאת אלהים אמר דברו ויש לכבד את דברי אלהים לשמוע בקולו גם אם קלל ושמעת בקולו והייתה לך ברכה</p><p>[גם אם אלהים ארר את האדמה בעבור האדם וציוה עליו להזיע כדי לאכול הלא כל מי שיזיע יציל את עצמו מכל המחלות המערביות]</p><p>כי בימי קדם לשבטי ישראל הייתה דרושה קירבה פיסית כדי ללמוד תורה מהכהן</p><p>התורה אמנם נלמדה דרך הראש ולא דרך הלב כי הכהנים הלוים נפוצו בישראל ונטמעו ונטמאו ולא יכלו לשמור טהרתם עד עת-קץ</p><p>מלאכי ג3: &quot;וְיָשַׁב מְצָרֵף וּמְטַהֵר כֶּסֶף וְטִהַר אֶת בְּנֵי לֵוִי וְזִקַּק אֹתָם כַּזָּהָב וְכַכָּסֶף וְהָיוּ ליהוה מַגִּישֵׁי מִנְחָה בִּצְדָקָה&quot;</p><p>ובזכות טהרת הלוים תהיה להם ברכה ברכת-אלהים והגורל שלהם יהיה לטובה ונחלת הקודש לבְּנֵי לֵוִי כִּי לָהֶם הָיָה הַגּוֹרָל רִיאשֹׁנָה</p><p>ואז בדור אחרית הימים לאחר טהרת הלוים בְּנֵי לֵוִי ולא יהיו עוד אָרוּרים לחלקם ולהפיצם כי ישבו אחים גם יחד </p><p>כי באחרית הימים בדור העתיד בדור הרוחני כל מה שנדרש כדי ללמוד תורה זה קרבה רוחנית לכהן</p><p>גם אם פלמוני נמצא בארץ רחוקה הוא יכול דרך הכהן לדרש את האלהים</p><p>בדור אחרית הימים תהיה תקשורת רוחנית [יותר טובה מהאינטרנט] וכולם יוכלו לתקשר עם הכהן</p><p>מלאכי ב7: &quot;כִּי שִׂפְתֵי כֹהֵן יִשְׁמְרוּ דַעַת וְתוֹרָה יְבַקְשׁוּ מִפִּיהוּ כִּי מַלְאַךְ יהוה צְבָאוֹת הוּא&quot;</p>',
		'https://www.google.com/accounts/o8/id?id=AItOawkimwFyqevXh2gjrVPHX9qj0eFdlDWJLww',
		'Daian Moshe',
		'2015-04-07 18:56:29'
		)
...
SET character_set_connection=utf8;
			...
			UPDATE tguvot 
			SET deleted_at='2015-04-23 09:55:06' 
			WHERE messageid=4576;
...
SET character_set_connection=utf8;
			...
			UPDATE tguvot 
			SET deleted_at='2015-04-23 09:57:36' 
			WHERE messageid=4577;
