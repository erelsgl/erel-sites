...
SET character_set_connection=utf8mb3;
		...
		INSERT INTO tguvot (parent,body,userid,username,created_at) VALUES (
		'tnk1/messages/prqim_t0101_23.html',
		'<p>ויקרא כג39: &quot;אַךְ בַּחֲמִשָּׁה עָשָׂר יוֹם לַחֹדֶשׁ הַשְּׁבִיעִי בְּאָסְפְּכֶם אֶת תְּבוּאַת הָאָרֶץ תָּחֹגּוּ אֶת חַג יהוה שִׁבְעַת יָמִים בַּיּוֹם הָרִאשׁוֹן שַׁבָּתוֹן וּבַיּוֹם הַשְּׁמִינִי שַׁבָּתוֹן&quot; </p><p>ככה יש להתייחס מבחינת הימים כאשר כתוב שבעת ימים זה מן היום הראשון עד כולל היום השמיני</p><p>גם כאשר התינוק נולד עושים לו ברית מילה כעבור שבוע ימים אך זה כבר היום השמיני</p><p>ויקרא ח35: &quot;וּפֶתַח אֹהֶל מוֹעֵד תֵּשְׁבוּ יוֹמָם וָלַיְלָה שִׁבְעַת יָמִים וּשְׁמַרְתֶּם אֶת מִשְׁמֶרֶת יהוה וְלֹא תָמוּתוּ כִּי כֵן צֻוֵּיתִי&quot;</p><p>ויקרא ח33: &quot;וּמִפֶּתַח אֹהֶל מוֹעֵד לֹא תֵצְאוּ שִׁבְעַת יָמִים עַד יוֹם מְלֹאת יְמֵי מִלֻּאֵיכֶם כִּי שִׁבְעַת יָמִים יְמַלֵּא אֶת יֶדְכֶם&quot;</p><p>ויקרא י7: &quot;וּמִפֶּתַח אֹהֶל מוֹעֵד לֹא תֵצְאוּ פֶּן תָּמֻתוּ כִּי שֶׁמֶן מִשְׁחַת יהוה עֲלֵיכֶם וַיַּעֲשׂוּ כִּדְבַר מֹשֶׁה&quot;</p><p>  וּשְׁמַרְתֶּם אֶת מִשְׁמֶרֶת יהוה =   שִׁבְעַת יָמִים עַד יוֹם מְלֹאת יְמֵי מִלֻּאֵיכֶם =   כִּי שֶׁמֶן מִשְׁחַת יהוה עֲלֵיכֶם</p><p>מן היּוֹם הָרִאשׁוֹן עד היּוֹם הַשְּׁמִינִי = סך הכל שמונה ימים למילואים כל שבע שנים מושחים את הכהנים</p><p>משיחת הכהנים בשמונה ימי מילואים אשר חלים בטרם תיפתח השנה החדשה בראש החודש הראשון לאמור בטרם וסמוך לראש חודש האביב</p>',
		'115934331744503251746',
		'DAIAN SHEM',
		'2025-06-28 18:08:44'
		)
...
SET character_set_connection=utf8mb3;
		...
		'<p>נסה את הרב דיקטה:</p><p>https://rav.dicta.org.il</p><p>אפשר לשאול אותו שאלות על פירושי פסוקים, ולפעמים הוא עונה</p>',
		'117606350813040384070',
		'Erel Segal-Halevi',
		'2025-06-29 06:21:43'
		)
