...
/* return the day in March on which Pesach falls in the given Hebrew year. */
function Gauss(year) {
	var a,b,c;
	var m;
...
/* return true if the given Gregorian year has 29 days in February */
function leap(y) {
	return ((y % 400 == 0) || (y % 100 != 0 && y % 4 == 0));
}

/* return the number of days in the given Gregorian month and year */
...
/* return a string that shows the Hebrew date in the given Gregorian date */
