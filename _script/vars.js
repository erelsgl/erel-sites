...
*/
	...
	if (theAuthor.length>1 && !/erelsgl|brain/.test(path_from_root_to_document) && !(site == "horsha")) {
		if ((theAuthor=="àøàì" || theAuthor=="àøàì ñâì"))
			...
			authorForTitle = 
				"îåøä ìúåøä îùä ãéï" + " (<a href='/tnk1/daian.html'>ìééòåõ åúøåîåú</a>)";
				// authorLink("îåøä ìúåøä îùä ãéï", "daian1enator","gmail.com") 
...
function tguva() {
	...
	if (/áøåøéä/.test(theAuthor)) {
		document.write('<div style="font-style:italic">ðéúï ìéöåø ÷ùø òí äëåúáú ãøê <a href="https://www.mycreation.co.il" target="_blank">äàúø ùìä</a>.</div>');
	} else {
		if (!theTvnit.length)
	...
	if (theTvnit.length>0) {
		...
		document.write(
			...
			"<div id='addlink'>\n"+
				"<p><b>ä÷éùåø:</b> <input type='text' name='qijur' dir='ltr' value='https://' size='90' style='font-size:10px'/></p>\n"+
			"</div>\n"+
