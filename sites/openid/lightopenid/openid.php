...
class LightOpenID
{
    ...
    function validate()
    {
        ...
        if(isset($this->data['openid_user_setup_url'])) {
            //print "<p>openid_user_setup_url</p>\n";
            $this->setup_url = $this->data['openid_user_setup_url'];
            return false;
        }
        if($this->mode != 'id_res') {
            //print "<p>mode=".$this->mode."</p>\n";
            return false;
        }
        ...
        if ($this->data['openid_return_to'] != $this->returnUrl) {
            //print "<p>openid_return_to=".$this->data['openid_return_to']."returnUrl=".$this->returnUrl." </p>\n";
    ...
    function getAttributes()
    {
		...
		/**
     * Use only if $this->validate() returned true!
     */
		function getNameForDisplay() {
			...
			if (isset($attributes["namePerson/first"])) {
				if (isset($attributes["namePerson/last"])) {
					...
					return $attributes["namePerson/first"];
				}
			} elseif (isset($attributes["contact/email"])) {
