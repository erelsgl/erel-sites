...
require_once dirname(__FILE__).'/XmlElements.php';
...
class MediawikiClient {
		...
		*/
		function page_cached($title, $table_name, $compile_function=NULL, $refresh=FALSE, $parsed=FALSE, $check_timestamp=TRUE) {
				...
				if ($DEBUG) require_once(dirname(__FILE__)."/../script/benchmark.php");
				require_once(dirname(__FILE__)."/../script/pack.php");
				require_once(dirname(__FILE__)."/../script/sql.php");
